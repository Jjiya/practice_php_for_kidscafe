...
//{
    ...
    $name = date("ymd_His_", time()) . $FILE["name"]."<br>";
...
// 이미지 파일이 맞는지 검사.
    if ($fileType == 'image') {
        ...
        if ($extStatus) {
            // 임시 파일 옮길 디렉토리 및 파일명
            $resFile = $_SERVER['DOCUMENT_ROOT'] . "/uploads/{$name}";
//            $resFile = $_SERVER['DOCUMENT_ROOT'] . "/uploads/{$_FILES['imgFile']['name']}";
